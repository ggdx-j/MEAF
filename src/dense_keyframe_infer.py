"""Dense Keyframe Evidence: Whisper transcript plus uniform and scored keyframe visual evidence."""
...
def load_model(model_path: str, dtype: str, device_map: str):
    ...
    model = AutoModelForImageTextToText.from_pretrained(
        ...
        offload_folder="outputs/offload_dense_keyframe",
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--config", default="config/dense_keyframe.json")
    parser.add_argument("--output-file", default="outputs/dense_keyframe_3108_answer_only.jsonl")
...
def main() -> None:
    ...
    for row in tqdm(rows, desc="Dense Keyframe Evidence"):
